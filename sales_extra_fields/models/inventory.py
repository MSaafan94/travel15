...
class SaleOrderTemplateOption(models.Model):
    ...
    field_type = fields.Selection([('room', 'Room'), ('visa', 'Visa'), ('program', 'Program'), ('domestic', 'Domestic'), ('international', 'International')], compute='compute_type',)
